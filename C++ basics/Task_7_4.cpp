...
double Print(int n, float array[])
...
double Print(int n, double array[])
...
int main()
{
	...
	cout << "average_value(6,x) = " << Print(6, x);
	cout << "average_value(6,f) = " << Print(6, f);
	cout << "average_value(6,y) = " << Print(6, y);
	cout << "average_value(6,z) = " << Print(6, z);
	return 0;
}